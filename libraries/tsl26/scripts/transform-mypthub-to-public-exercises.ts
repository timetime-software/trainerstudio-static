...
const DEFAULT_INPUT_PATH = path.resolve(process.cwd(), 'data/mypthub-exercises.csv');
const DEFAULT_OUTPUT_PATH = path.resolve(process.cwd(), 'data/mypthub-public-exercises.json');
