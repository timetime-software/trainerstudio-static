...
const DEFAULT_INPUT_PATH = path.resolve(process.cwd(), 'data/mypthub-public-exercises.json');
const DEFAULT_SHARDS_DIR = path.resolve(process.cwd(), 'data/i18n-shards');
